...
export const workStudies = [
  ...
  },
  {
    ...
    lead: "Proof of quality, made visible. Every batch, every test, every step shown in the open.",
    description: [
      "Medivance is the storefront and admin platform for a US research-peptide brand. Visitors can browse the catalog, follow how each product is made, and see the analytical data behind every batch.",
      "Trust depends on clear proof. The site uses a calm, clinical visual language, from a cinematic full-screen hero to a scroll-stacked, five-step manufacturing process, so people can see where each quality check sits, from sourcing to shipping.",
      "Behind the storefront, an admin dashboard manages the catalog, product types, SKUs, pricing, and pending affiliate approvals. This gives the brand a modular foundation to add products and grow its partner network.",
    ],
