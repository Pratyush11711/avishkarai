...
const PILLARS = [
  {
    ...
    body: "Multi-tenant architecture. Role-based access control. Audit logging. Encryption in transit and at rest. Automated CI/CD, real test coverage, documented APIs, infrastructure as code. Most MVPs are demos with a database behind them, and they get thrown away the moment you get traction. Ours are the first version of the system you'll still be running at Series B.",
    closing: "We build the thing you scale, not the thing you replace.",
  },
  {
    num: "02",
    heading: "Designed like a product, not a project",
    body: "Your first users, your first investors, and your first enterprise buyer all form their opinion in about four seconds. We don't hand that moment to a template. Every build ships with a real design system: typography, motion, states, empty states, error states, dark mode where it matters. Interfaces our clients' customers assume were made by a fifteen-person in-house team.",
    closing: "Nobody should be able to tell it's version one.",
  },
  {
    num: "03",
    heading: "Shipped on a clock, not a hope",
    body: "Fixed scope. Fixed price. Weekly deploys. A named senior engineer and a founder who answers directly, not an account manager relaying messages across a time zone. If we miss a Thursday, you hear about it Wednesday, with the reason and the new date.",
